...
import com.app.santabanta.Adapter.PlayerViewHolder;
 ...
 * Author     : AndroidWave
 */
public class MemesExoPlayerRecyclerView extends RecyclerView {
    ...
    public MemesExoPlayerRecyclerView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public MemesExoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
